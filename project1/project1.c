...
gcc -o task4 task4.c
xxd -c 64 task4 | grep AA

head -c 12352 task4 > task4_prefix
md5collgen -p task4_prefix -o task4_prefix_p.bin task4_prefix_q.bin

tail -c +12481 task4 > task4_suffix
cat task4_prefix_p.bin task4_suffix > task4_p
cat task4_prefix_q.bin task4_suffix > task4_q

tail -c 128 task4_prefix_p.bin > _p

head -c 12576 task4_p > task4_p_prefix
cat task4_p_prefix _p > task4_p_prefix_p

tail -c +12705 task4 > task4_lastsuffix
cat task4_p_prefix_p task4_lastsuffix > task4_pp
...
head -c 12576 task4_q > task4_q_prefix
cat task4_q_prefix _p > task4_q_prefix_p

cat task4_q_prefix_p task4_lastsuffix > task4_pq
